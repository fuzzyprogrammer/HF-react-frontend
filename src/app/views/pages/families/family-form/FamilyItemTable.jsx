...
import { getContactTypeList } from "./FamilyFormService";

const FamilyItemTable = ({ values, handleChange, setFieldValue }) => {
                ...
                <TableRow className="position-relative" key={ind}>
                  ...
                  <TableCell colSpan={5} className="p-0" align="left">
                    <TextField
                      ...
                      size="small"
                      variant="outlined"
                      type={ values.contacts[ind].type === 'Email' && 'email' | 'tel' }
                      fullWidth
                      value={item.value || ""}
                      onChange={handleChange}
                    />
...
export default FamilyItemTable;
